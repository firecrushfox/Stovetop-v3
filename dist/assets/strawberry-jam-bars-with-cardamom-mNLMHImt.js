const e=`---
title: "Strawberry Jam Bars With Cardamom"
source: "https://cooking.nytimes.com/recipes/1023713-strawberry-jam-bars-with-cardamom"
...
tags:
  ...
  - christmas
cuisine: ""
image: "https://static01.nyt.com/images/2022/12/07/multimedia/YK-jam-bars-1-a209/YK-jam-bars-1-a209-videoSixteenByNineJumbo1600.jpg"
...
4. (If you’re starting with a half batch of Butter Shortbread Dough, start here.) Heat the oven to 350 degrees. Add the ground cardamom and mix with your fingers to incorporate it into the dough. Remove 1 cup of the crumbled dough to a small bowl and refrigerate. Transfer the remaining dough to the buttered pan and flatten into an even layer by pressing into the pan using the flat bottom of a glass. Bake on the middle rack until the edges are golden brown and begin to pull away from the sides of the pan, about 30 minutes. Cool in the pan slightly, for at least 15 minutes.
5. Spread the fruit jam in an even layer over the surface of the crust. Zest the lemon right over the top of the jam, and sprinkle with the chopped nuts and reserved crumble. Return to the oven and bake, rotating once, until the top is golden brown and the jam is sizzling around the edges, about 35 minutes. Cool completely in the pan, at least 1 1/2 hours. Run a knife along the edges to release the sides. Use the parchment to lift the cookie out of the pan onto a cutting board. Dust the top with confectioners' sugar. Cut the cookie into 4 strips, then cut each strip into six 1-inch wide bars.

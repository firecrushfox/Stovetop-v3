const e=`---
title: "Braised Goat Leg in Obe Ata"
source: "https://cooking.nytimes.com/recipes/1020284-braised-goat-leg-in-obe-ata"
...
tags:
  ...
  - thanksgiving
cuisine: ""
image: "https://static01.nyt.com/images/2019/06/26/dining/24Nigerianrex4/merlin_156696663_fe8c024d-6871-46b0-b732-333ee978a62e-videoSixteenByNineJumbo1600.jpg"
...
## Instructions
1. Heat 2 tablespoons canola oil in a large Dutch oven or heavy-bottomed, ovenproof pot over medium-high. Season the goat leg generously all over with salt, then sear, turning frequently, until browned, 10 to 20 minutes, depending on how many pieces. Transfer to a large bowl using tongs.
2. Heat the oven to 350 degrees. Sear the garlic bulb halves in the rendered fat, cut-side down, until golden brown, 1 to 2 minutes. Transfer to the bowl with the goat. Cook the carrots and onions with a pinch of salt, stirring occasionally, until vegetables are just beginning to soften and brown at the edges, about 8 minutes. Add the tomatoes and their juices, tearing the whole tomatoes into large chunks with your hands as you add them. Add the thyme, bay leaves and habanero.
3. Stir in the stock and bring to a simmer over medium-high. Return the goat and garlic to the Dutch oven, cover and transfer to the oven. Braise until meat is tender but doesn’t fall apart, 2 1/2 to 3 hours.
4. Meanwhile, prepare the obe ata: Combine all the obe ata ingredients except the oil in a blender and purée on high until smooth, working in batches, if needed. The liquid from the can of tomatoes should suffice, but you can add up to 1/4 cup of water if necessary to get the purée going. (You should have about 6 cups of purée.)
...
6. Remove the Dutch oven from the oven and increase the oven temperature to 375 degrees. Transfer the goat to a large bowl using tongs. Strain the broth, discarding the solids, and return the broth to the Dutch oven. (You should have 2 to 3 cups.)
7. Add the obe ata to the Dutch oven and bring the sauce up to a simmer over medium-high. Cook, stirring occasionally, until flavors meld and sauce thickens slightly, about 20 minutes. Season with salt and place the goat leg back in, ladling sauce over the top of the goat if it is not completely submerged. Cover with lid and return to the oven. Braise until the goat is tender enough to pull with a fork and just beginning to fall off the bone, about 45 minutes.
8. To serve, place the goat in a deep serving platter with the meat on the bone, or off the bone in large chunks with the obe ata spooned generously over the meat. Scatter the top with the lemon zest, fresh herbs and scallions.
